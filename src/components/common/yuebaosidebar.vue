        ...
        <div id="body">
          ...
          <table class="table table-bordered table-hover">
            ...
            <tr >
              ...
              <!--<td>80%</td>-->
              <!--<td>{{tabledata2.tmorrowPlan}}</td>-->
              <!--<td>{{tabledata2.workScore}}</td>-->
            </tr>
            <tr >
              <td colspan="4" >月评价：<span class="score">
              {{tabledata2.monthlySummary}} </span></td>
              <!--<td>{{tabledata2.tmorrowPlan}}</td>-->
              <!--<td>{{tabledata2.tomPlansco}}</td>-->
            </tr>
            <tr>
              <td colspan="4" >下月评价：<span class="score">
              {{tabledata2.nextmonthPlan}} </span></td>
              <!--class="comprehensive"-->
              <!--{{tabledata2.finalScore}}-->
            </tr>
            <tr>
              <!--<td  colspan="4">-->
                ...
                <!--<el-radio-group v-model="tabledata2.attendance*1">-->
                  <!--<el-radio disabled  :label="0.5">0.5天（请假）</el-radio>-->
                <!--<el-radio disabled  :label="1">1天（正常上班）</el-radio>-->
                <!--<el-radio disabled :label="1.5">1.5天（晚上加班）</el-radio>-->
                <!--&lt;!&ndash;:disabled="tabledata.flag==1?false:true" 判断是否禁用&ndash;&gt;-->
                <!--</el-radio-group>-->
              <!--</td>-->
            </tr>
            <tr>
              <td  colspan="4" >
                <!--<strong> <i class="el-icon-check check"></i>  最终得分：<span class="score">{{tabledata2.finalScore}}</span>  <em class="chuqinlv">（指标打分合计 + 加分 - 扣分）×出勤率</em> </strong>-->
                <!--<br>-->
...
<script>
  ...
  export default {
    ...
    data(){
      return {
        //评语
        dialogTextarea:this.tabledata2.comment,
        //function
        bool2:false,
        time:"",
        tableData:[
    ...
    computed:{
      score(){
        // return  this.tabledata2.workScore*1 + this.tabledata2.tomPlansco*1
      }
    }
  }
